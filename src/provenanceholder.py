import ed25519
import config
import controller_db.models as controller_models
import util
from components import adapter as a, provider as p, controller as c
...
if __name__ == '__main__':
    ...
    # Add two users with public and private keys for the purpose of signing dummy data
    ...
    # Two query entries that can be used for testing
    ...
    results = provenance_holder.adapter.retrieve(query_entry_1, provenance_holder, 'execution')
